...
namespace Компания.EmotionsLanguage
{
	...
	/// </summary>
	internal partial class EmotionsLanguageCommandSet : EmotionsLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new EmotionsLanguageCommandSet.
		/// </summary>
		public EmotionsLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class EmotionsLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new EmotionsLanguageCommandSetBase.
		/// </summary>
		protected EmotionsLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewEmotionsLanguageExplorerCommand,
				typeof(EmotionsLanguageEditorFactory).GUID);
		...
		{
			EmotionsLanguageExplorerToolWindow explorer = this.EmotionsLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected EmotionsLanguageDocData CurrentEmotionsLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as EmotionsLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected EmotionsLanguageDocView CurrentEmotionsLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as EmotionsLanguageDocView;
			}
		}
		...
		/// </summary>
		protected EmotionsLanguageExplorerToolWindow EmotionsLanguageExplorerToolWindow
		{
			get
			{
				EmotionsLanguageExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(EmotionsLanguageExplorerToolWindow), true) as EmotionsLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				EmotionsLanguageExplorerToolWindow explorerWindow = this.EmotionsLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class EmotionsLanguageClipboardCommandSet : EmotionsLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new EmotionsLanguageClipboardCommandSet.
		/// </summary>
		public EmotionsLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class EmotionsLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new EmotionsLanguageClipboardCommandSetBase.
		/// </summary>
		protected EmotionsLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}

...
namespace Компания.EmotionsLanguage
{
	...
	/// </summary>
	internal partial class EmotionsLanguageDocData : EmotionsLanguageDocDataBase
	{
		/// <summary>
		/// Constructs a new EmotionsLanguageDocData.
		/// </summary>
		public EmotionsLanguageDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a EmotionsLanguage document in memory.
	/// </summary>
	internal abstract partial class EmotionsLanguageDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new EmotionsLanguageDocDataBase.
		/// </summary>
		protected EmotionsLanguageDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Компания.EmotionsLanguage.ExampleModel modelRoot = null;
			...
			global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Компания.EmotionsLanguage.EmotionsLanguageSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Компания.EmotionsLanguage.ExampleModel modelRoot = (global::Компания.EmotionsLanguage.ExampleModel)this.RootElement;
			...
			{
				global::Компания.EmotionsLanguage.EmotionsLanguageDiagram diagram = diagrams[0] as global::Компания.EmotionsLanguage.EmotionsLanguageDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Компания.EmotionsLanguage.EmotionsLanguageSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Компания.EmotionsLanguage.EmotionsLanguageSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Компания.EmotionsLanguage.EmotionsLanguageDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Компания.EmotionsLanguage.EmotionsLanguageSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Компания.EmotionsLanguage.ExampleModel modelRoot = this.RootElement as global::Компания.EmotionsLanguage.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Компания.EmotionsLanguage.EmotionsLanguageSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
